...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Olgy Est Un Chat.", "author": "Shiina" },
            { "message": "Je Suis Pas La Mascotte Mais Un Admin.", "author": "Olgy" },
            { "message": "Linux n'est pas un os, mais un kernel.", "author": "Shiina" }
        ];
